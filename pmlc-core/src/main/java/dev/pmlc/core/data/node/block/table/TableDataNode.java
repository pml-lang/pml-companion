...
import dev.pmlc.core.data.formalnode.block.table.FormalTableDataNode;
...
public class TableDataNode extends PMLBlockNode {
    ...
    public @NotNull FormalPMLNode<String, TableDataNode> getFormalNode () {
        return FormalTableDataNode.NODE;
    }
    ...
    public void createAttributes ( @Nullable Parameters parameters ) throws Exception {
        ...
        horizontalColumnAlignmentsString = parameters == null ? null :
            parameters.getNullable ( FormalTableNode.HORIZONTAL_ALIGNMENTS_ATTRIBUTE  );
    }

...
public class PMLDocumentWriter extends BasicDocumentWriter {
    ...
    public PMLDocumentWriter writeDocNodeStartLine (
        ...
        return writeDocOrChapterNodeStartLine ( DocumentNodeSpec.NAME, title, escapeTitle, null );
    }
    ...
    public PMLDocumentWriter writeChapterNodeStartLine (
        ...
        return writeDocOrChapterNodeStartLine ( ChapterNodeSpec.NAME, title, escapeTitle, id );
    }
    ...
    private PMLDocumentWriter writeDocOrChapterNodeStartLine (
        ...
        writeInlineNodeWithTextContent ( TitleNodeSpec.NAME.toString(), null, title, escapeTitle );
        writeNewLine();
        increaseIndent();
    ...
    public PMLDocumentWriter writeParagraph (
        ...
        writeBlockNodeWithTextContent ( ParagraphNodeSpec.NAME.toString(), null, text, escapeText );
    ...
    public void writeParameterSpecs ( @NotNull List<? extends ParameterSpec<?>> parameters ) throws IOException {

        writeCollection (
            parameters,
            (parameter, writer) -> writer.writeParameterSpec ( parameter, this ) );
    }

    public <T> void writeParameterSpec (
        @NotNull ParameterSpec<T> parameter,
        @NotNull PMLDocumentWriter writer ) throws IOException {

        @NotNull String name = parameter.getName();
        @Nullable String title = parameter.documentationTitle ();
        ...
        putDescription ( parameter.documentation (), map );
        ...
        @Nullable String defaultValue = parameter.defaultValueAsString ();
        ...
        String examples = parameter.documentationExamples ();
        if ( examples != null )
    ...
    public void writeCommands ( @NotNull List<CommandSpec<?,?>> commands ) throws Exception {
    ...
    public void writeCommand ( @NotNull CommandSpec<?,?> command ) throws Exception {

        @NotNull String name = command.getName();
        @Nullable String title = command.documentationTitle ();

        startChapter ( title != null ? title : name, "command_" + name );

        writeName ( name );
        writeAlternativeNames ( command.getAlternativeNames() );
        writeDocDescription ( command.documentation () );
        writeDocExamples ( command.documentation () );

        writeHeader ( "Input Parameters" );
        @Nullable ParameterSpecs parameters = command.getInputParameters();
        if ( parameters == null ) {
            writeParagraph ( "This command has no input parameters" );
        } else {
            writeParameterSpecs ( parameters.listSortedByPositionalIndexThenName () );
        }
